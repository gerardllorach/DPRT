export function displayInstructions(canvas, text, onFinish, offsetX, offsetY){
	...
	ctx.fillStyle = "white";
	ctx.fillText(text, canvas.width / 2 - ctx.measureText(text).width/2 + offsetX, canvas.height/2 + offsetY);
